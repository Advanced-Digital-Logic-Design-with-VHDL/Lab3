...
HD_PWD='E:/MadeehaReq5_6/traffic_intersection.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log traffic_intersection.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source traffic_intersection.tcl
