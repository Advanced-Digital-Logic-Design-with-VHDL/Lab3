...
HD_PWD='E:/MadeehaReq5_6/traffic_intersection.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log traffic_intersection.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source traffic_intersection.tcl -notrace
